...
![Cobbler-3.3.6-Beginners_Physical.drawio](/assets/img/Cobbler-3.3.6-Beginners_Physical.jpg){width=50%}
...
![Cobbler-3.3.6-Beginners_Logical.drawio](/assets/img/Cobbler-3.3.6-Beginners_Logical.jpg){width=50% height=50%}
...
Confirm SSH is enabled on the system, allowing for remote administration of the Cobbler server:
