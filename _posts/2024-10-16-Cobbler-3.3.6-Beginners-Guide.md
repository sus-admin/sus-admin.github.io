...
2. Fedora installations, whether installed manually or automatically, should always contain an "anaconda-ks.cfg" file located in the "/root" directory which is a kickstart file that could be used to install a new system identical to the local system.
