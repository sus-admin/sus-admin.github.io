...
<code>{% include suse-15.6-autoyast.xml path="_includes/suse-15.6-autoyast.xml" %}</code>

    - suse-15.6-networking.xml

<pre>{% include suse-15.6-networking.xml path="_includes/suse-15.6-networking.xml" %}</pre>

    - suse-15.6_scriptwrapper.xml

<pre>{% include suse-15.6_scriptwrapper.xml path="_includes/suse-15.6_scriptwrapper.xml" %}</pre>

    - autoinstall_start

<pre>{% include autoinstall_start path="_includes/autoinstall_start" %}</pre>

    - autoinstall_done

<pre>{% include autoinstall_done path="_includes/autoinstall_done" %}</pre>
