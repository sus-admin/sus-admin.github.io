...
{% include suse-15.6-autoyast.xml path="_includes/suse-15.6-autoyast.xml" %}

    - suse-15.6-networking.xml

{% include suse-15.6-networking.xml path="_includes/suse-15.6-networking.xml" %}

    - suse-15.6_scriptwrapper.xml

{% include suse-15.6_scriptwrapper.xml path="_includes/suse-15.6_scriptwrapper.xml" %}

    - autoinstall_start

{% include autoinstall_start path="_includes/autoinstall_start" %}

    - autoinstall_done

{% include autoinstall_done path="_includes/autoinstall_done" %}
